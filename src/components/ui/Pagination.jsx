...
const Pagination = ({
  ...
  const pageEnd = Math.min(currentPage * safePageSize, safeTotal);

  return (
    <div className={`bg-[var(--color-neutral-secondary-bg)] flex justify-between items-center py-2 px-4 ${className}`}>
      ...
      <div className="flex gap-3">
        ...
        <Button
          ...
          className="flex !px-2 items-center justify-center"
          onClick={onNext}
          disabled={currentPage >= totalPages || safeTotal === 0}
        >
