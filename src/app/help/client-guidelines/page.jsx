...
const faqs = [
  {
    href: "/help/troubleshooting?from=client",
    icon: <Icon name="shield" className="text-[var(--color-admin-profile-border)] opacity-100" />,
    title: "Onboarding",
    className: "!h-[300px] !py-auto",
  },
  {
    href: "/help/troubleshooting?from=client",
    icon: <Icon name="box_plus" className="text-[var(--color-admin-profile-border)]" />,
    title: "Assignments",
    className: "!h-[300px] !py-auto",
  },
  {
    href: "/help/troubleshooting?from=client",
    icon: <RiLoopRightFill className="w-8 h-8 text-[var(--color-admin-profile-border)]" />,
    ...
    <div className="relative min-h-[calc(100vh-120px)]">
      <div className="pb-20">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-lg font-semibold text-[var(--color-neutral-primary)] mb-1">Client Guidelines</h1>
            <p className="text-base text-[var(--color-stroke-brand)]">Step-by-step playbooks for onboarding, assignments, and ownership transfers.</p>
          </div>
        </div>
        <HelpSearchInput data={helpSearchData} onSelect={handleSearchSelect} placeholder="Search FAQs" helpSearch={true}/>
